...
!   
   write(*,17)t1,tersys(t1)%asymm,tersys(t1)%isasym
...
!
   missasym=0
   write(*,5)
5  format(/'3XQ In set_ternary_asymmetry called from gtp3E')
