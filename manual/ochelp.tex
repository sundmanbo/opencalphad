...
%.........................
\hypertarget{Default constitution}{}
...
%...................
\hypertarget{Amend for species}{}

The species symbol must be given.

You will then be asked for the volume and area of the species to be
used calculating the configurational entropy of the fluid.
...
\hypertarget{Enter phase constit}{}
...
\begin{tabular}{llll}
 APPEND           & LINE\_WITH\_POINTS~ & PAUSE\_OPTIONS     & SCALE\_RANGES \\
 AXIS\_LABELS     & LOGSCALE            & POSIION\_OF\_KEYS~ & TEXT\\  
 FONT\_AND\_COLOR~ & MANIPULATE\_LINES~ & QUIT               & TIE\_LINES\\
 GIBBS\_TRIANGLE   & MISCELLANEOUS      & RATIOS\_XY         & TITLE\\
 GRAPHICS\_FORMAT~ & OUTPUT\_FILE       & RENDER           \\
\end{tabular}
...
\item MISCELLANEOUS is what it says
...
%----------------------------------------------------
\hypertarget{PLOT font-and-color}{}
...
%----------------------------------------------------
\hypertarget{PLOT line-with-points}{}
\subsection{{\em plot xaxis yaxis} Line-with-points}

Not implemente yet

%----------------------------------------------------
\hypertarget{PLOT logscale}{}
...
One or more optimizing coefficients are assigned a fixed value.
...
This is a new idea to have global variables.
...
\hypertarget{Set component name:}{{\bf Component name:}}

\hypertarget{Set reference phase}{{\bf Reference phase:}}

For each component (also for other components than the elements) you
can specify a phase at a given temperature and pressure as reference
state.  The phase must exist for the component as pure.

\hypertarget{Set reference T}{{\bf Temperature:}}

Instead of a fixed $T$ you can give a *, indicating current $T$, if
you calculates at different values of $T$.

\hypertarget{Set reference P}{{\bf Pressure:}}
...
%--------------------------------
\hypertarget{Set initial T and P}{}
