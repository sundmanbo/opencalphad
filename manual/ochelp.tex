...
% browser window.  The user can the scroll the whole manual in this window
%
...
For installation of the help system please read the installation
guide.
...
The models for phases can use many different models and sets of
constituents to describe Long Range Ordering (LRO) and Short Range
Orderng (SRO).  Some phases can exist only for a specific composition,
or for only a subset of the components of a system.
...
{\small
\begin{tabular}{llll}
 ALL-EQUILIBRIA~ & NO-GLOBAL~ & SYMBOL         & TZERO-POINT \\
 EQUILIBRIUM    & PHASE *    & TPFUN-SYMBOLS~  & WITH-CHECK-AFTER\\
...
%--------------------------------
\hypertarget{TZERO}{}
\subsection{{\em calculate} Tzero point}
...
\begin{tabular}{llll}
 CHANGES         & DATABASES   &  HELP-SYSTEM   & PROPERTY-DIAGRAM\\
 COMPOSITION-SET~& ELEMENTS    &  PHASE         & QUIT-INFO\\
 CONDITIONS      & EQUILIBRIUM~&  PHASE-DIAGRAM~& SPECIES\\
\end{tabular}
...
{\small
\begin{tabular}{llll}
FONT\_AND\_COLOR    & LOGSCALE          & NO\_HEADING    & RATIOS\_XY\\
...
can select any of these commands:
