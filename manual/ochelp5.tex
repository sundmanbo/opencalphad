...
The OpenCalphad (OC) initiative aims to provide a free high quality
software for thermodynamic calculations, including property and phase
diagrams, assessment of databases and a thermodynamic library for
simulations for inorganic systems i.e.  gases. liquids, alloys and
other materials using many different kinds of models for the phases.
There are three papers published about OC~\cite{15Sun1,15Sun2,16Sun}.
General information about thermodynamic models, calculations and
assessments based on the Calphad technique can be found in the book by
Lukas et al~\cite{07Luk}.  The software is provided free with a GNU
GPL license.
...
A list of the model parameter identifiers (revised in May 2018)
currently defined can be obtained by the command {\bf LIST
  MODEL\_PARAM\_ID}:
...
Indx Ident T P Specification                Status Note
  ...
  12 CBT   T P                                   2 Crystal breakdown T
  ...
  16 THT2  T P                                   2 Second Einstein T
  17 DCP2  T P                                   2 Second Einstein Delta-Cp
...
\item MG\&C, a parameter for the magnetic factor of the mobility of
  constituent C.
\item THT2, Second Einstein temperature.
\item DCP2, Second Einstein $\Delta C_P$.
...
\item TSCH, a parameter for Schottky anomality T
\item CSCH, a parameter for Schottky anomality $\Delta C_P$.
\end{itemize}
