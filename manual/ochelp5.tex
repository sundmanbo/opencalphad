...
%
% Problem when opening the HTML file to list the help text:
...
window and with the whole user guide and try to position the text at a
relevant section.

This feature is very new and is still under development. Feedback is
helpful.  It can be turned off by a command~\ref{sc:help-popup}.
...
included in this guide but those which are will be {\bf shown in
  bold}.  References to other commands are sometimes in bold.
...
%\subsubssection{CRYSTAL_BREAKDWN}
