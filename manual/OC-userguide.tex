...
%
% The _ used in many commands must be replaced by \_
%
%---------------------------------------------------
%
...
% Any text found in this file from the command/question found up to 
% the next command will be written on the screen and 
...
%F        ['DATA            ','SHORT           ','PHASE           ',&
%F         'STATE_VARIABLES ','REFERENCES      ','PARAMETER_IDENTI',&
%F         'AXIS            ','TPFUN_SYMBOLS   ','QUIT            ',&
%F         '                ','EQUILIBRIA      ','RESULTS         ',&
%F         'CONDITIONS      ','SYMBOLS         ','                ']
%F !-------------------
...
%F         'PHASE           ','PARAMETER       ','REFERENCE       ',&
%F         'CONSTITUTION    ','EXPERIMENT      ','QUIT            ',&
%F         'EQUILIBRIUM     ','SYMBOL          ','                ']
%F !-------------------
...
%F        ['CONSTITUTION    ','STATUS          ','DEFAULT_CONSTITU',&
%F         'AMOUNT          ','BITS            ','                ']
%F !        123456789.123456---123456789.123456---123456789.123456
%F !-------------------
...
%F         'FACT_QUASICHEMCL','NO_AUTO_COMP_SET','ELASTIC_MODEL_A ',&
%F         '                ','                ','                ',&
%F         '                ','                ','                ']
%F !        123456789.123456---123456789.123456---123456789.123456
%F !-------------------
