...
{\bf Always add a bibliographic reference even if it is just your name
  and date.  This avoids people to mistake a value inspired by your
...
message if an error has occurred when using macro file.  This makes it
easier to to find errors occurring when running macro files.
...
conditions are mass balance conditions $H.T$ is the heat capacity.
...
\item Output all phases will with composition in mole fraction and 
  constitution in alphabetic order.  Unstable phases will have a negative driving force.
\item As 8 but in in value order.
\end{enumerate}
