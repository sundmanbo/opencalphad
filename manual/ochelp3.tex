...
%--------------------------------
\subsection{AMEND All optimizing coefficients}
...
%--------------------------------
\subsection{ENTER Optimize coefficient}
...
The P option lists one line for each phases, first the stable and then
the remaining in decreasing order of stability.

%--------------------------------
\subsection{LIST State\_ Variables}
