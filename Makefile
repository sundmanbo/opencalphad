OBJS=metlib3.o tpfun4.o lukasnum.o gtp3.o matsmin.o lmdif1lib.o smp1.o pmon6.o  
EXE=oc3B
...
$(EXE): 
	make $(OBJS)
# liboceq.a
	ar sq liboceq.a metlib3.o tpfun4.o lukasnum.o gtp3.o matsmin.o lmdif1lib.o 
# oc3A
