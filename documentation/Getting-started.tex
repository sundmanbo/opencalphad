...
\end{itemize}
\item news-OC5 about features and user interface.
\item UG, User Guide and manual.
\item OC-macros, examples how to use OC.
...
\item SMP, StepMapPlot describing calculation and plotting of diagrams (draft).
...
\caption{A very preliminary table with the state variables and their
  internal representation.  Some model parameter identifiers are also
  included.  The suffix ``z'' in Sz etc is the optional normalizing
...
MQ\&X  & - & phase\#set & constituent X & - & Mobility of X\\
